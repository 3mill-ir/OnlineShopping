<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Main.master" AutoEventWireup="true" CodeFile="RequestNewCategory.aspx.cs" Inherits="Views_RequestNewCategory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title><%="درخواست دسته بندی جدید" + " | " + Constants.StaticTitle %></title>
</asp:Content>
