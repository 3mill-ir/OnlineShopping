...
public partial class Views_Admin_EditMemberProfile2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Member member = mr.GetMember(Convert.ToInt32(Request.QueryString["MemberID"]));
            hid_MemberId.Value = member.MemberID.ToString();
    ...
    protected void btn_Save_Clicked(object sender, EventArgs e)
    {
        ...
        if (passIsCorrect)
        {
            //Get Member :
            MembersRepository mr = new MembersRepository();
            Member member = mr.GetMember(Convert.ToInt32(hid_MemberId.Value));
            //member :
