<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMaterialType.aspx.cs" Inherits="Views_Admin_NewMaterialType" %>
...
<body>
    ...
    <div>
        <asp:HiddenField ID="hidden_TypeID" runat="server" />
