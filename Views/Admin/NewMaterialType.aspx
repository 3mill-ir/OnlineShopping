<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewMaterialType.aspx.cs" Inherits="Views_Admin_NewMaterialType" %>
            ...
            <ContentTemplate>
                <table border="0" cellpadding="2" cellspacing="0" class="Centerize" style="margin-top : 25px;">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btn_Save" runat="server" ValidationGroup="Submit" Text="افـزوده شـود" CssClass="Buttons" Width="90px" OnClick="btn_Save_Clicked"/>
                        </td>
                        <td style="width : 16px;">
