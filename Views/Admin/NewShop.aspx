<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewShop.aspx.cs" Inherits="Views_Admin_NewShop" %>
...
<body>
    ...
    <div style="padding : 10px; margin-right : auto; margin-left : auto;">
        <Myc:PageTitle runat="server" Text="ایجــاد فـروشگاه جـدید"/>
            ...
            <ContentTemplate>
                <div class="ListTitle" style="margin-top : 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <asp:CheckBox ID="ch_CreateUser" runat="server" AutoPostBack="true" 
                                    Text="حسـاب کاربری ایجـاد شود" oncheckedchanged="ch_CreateUser_CheckedChanged"/>
                            </td>
                            <td align="left">
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="up_Save" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="btnSave" runat="server" Text="ایجـاد شود" CssClass="Buttons" Width="80px" OnClick="btn_Save_Clicked" ValidationGroup="SubmitForm"/>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
