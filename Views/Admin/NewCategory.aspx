<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewCategory.aspx.cs" Inherits="Views_Admin_NewCategory" %>
...
<body>
    ...
    <div style="padding : 10px;">
        <div class="Title_NewCategory"></div>
                ...
                <ContentTemplate>
                    <table border="0" cellpadding="3" cellspacing="0">
                        <tr>
                            ...
                            <td style="padding-right : 20px;">
                                <asp:Button ID="btn_Save" runat="server" Text="ایجـاد شـود" Width="90px" CssClass="Buttons" onclick="btn_Save_Click" ValidationGroup="Submit"/>
                            </td>
                            <td>
