<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewMaterial.aspx.cs" Inherits="Views_Admin_NewMaterial" ValidateRequest="false"%>
...
<body>
    ...
    <div style="padding : 10px; display: table; margin-right : auto; margin-left : auto;">
        <div class="PageTitle Title_NewMaterial"></div>
        ...
        <div class="TopDashed" style="padding-top : 5px; margin-top : 3px;">
            <table border="0" cellpadding="3" cellspacing="0" class="Centerize">
                ...
                <tr>
                    <td align="center">
                        <asp:Panel ID="pnl_PicsLink" runat="server" Visible="false">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-right : 15px;">
                                        <a class="Link" onclick="return OpenCenter('<%="MaterialPictures.aspx?MaterialID=" + MaterialID %>', 'MaterialPictures', 700, 500);">تصـاویر کـالا</a>
                                    </td>
                                    <td style="padding-right : 10px;">
                                        <a class="Link" onclick="return OpenCenter('<%="MaterialFields.aspx?MaterialID=" + MaterialID %>', 'MaterialFields', 600, 400);">جـزئیات کـالا</a>
                                    </td>
                                    <td style="padding-right : 10px;">
                                        <a class="Link" onclick="return OpenCenter('<%="SetPrice.aspx?MaterialID=" + MaterialID %>', 'SetPrice', 500, 100);">تنظیم قیمت فروش</a>
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
